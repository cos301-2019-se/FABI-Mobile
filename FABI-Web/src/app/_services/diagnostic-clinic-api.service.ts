...
const submitCMWDepositFormURL = '***REMOVED***/submitCMWDepositForm';
const submitCMWRequestFormURL = '***REMOVED***/submitCMWRequestForm';
const submitCMWRevitalizationFormURL = '***REMOVED***/submitCMWRevitalizationForm';
