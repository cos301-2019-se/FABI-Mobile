...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                             Submit CMW Processing Form
/**
 * @summary submit a CMW processing form
...
async function submitForm(req, res)
{
    if(await auth.authCCAdmin(req.headers.authorization)||await auth.authSuperUser(req.headers.authorization)||await auth.authStaff(req.headers.authorization)){
        ...
        if (req.body.userID == undefined || req.body.userID == '') {
            ...
            sampleRef = db.collection('CultureCollection').doc('CMWProcessing').collection('Forms').doc(id);
            ...
            sampleRef.set(req.body).then(()=>
            {
                ...
                log({
                    type: "ACCL",
                    statusCode: "200",
                    details: "/submitCMWProcessingForm",
