...
const requestOrganizationAccountRoute = require('./api/routes/FABI/requestOrganizationAccount');
...
app.use('/requestOrganizationAccount', requestOrganizationAccountRoute);
